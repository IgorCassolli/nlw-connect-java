...
public class SubscriptionService {
    ...
    public SubscriptionResponse createNewSubscription(String eventName, User user, Integer userId){
        ...
        if(tmpSub != null){ //Caso alternativo 3
            throw new SubscriptionConflictException("Já existe inscrição para o usuário " + userRec.getEmail() + " no evento " + evt.getPrettyName());
        }
    ...
    public SubscriptionRankingByUser getRankingByUser(String prettyName, Integer userId){
        ...
        if(item == null){
            throw new UserIndicadorNotFoundException("Usuário " + userId + " não existe no ranking do evento " + prettyName);
        }
